...
import { CreateFile_ReqInfo, CreateFile_ResInfo, Delete_ReqInfo, Delete_ResInfo, MoveUpDown_ReqInfo, MoveUpDown_ResInfo, SaveFile_ReqInfo, SaveFile_ResInfo, SetPublic_ReqInfo, SetPublic_ResInfo, UploadFiles_ReqInfo, UploadFiles_ResInfo, CreateFolder_ReqInfo, CreateFolder_ResInfo, BuildFolder_ReqInfo, BuildFolder_ResInfo, RenameFolder_ReqInfo, RenameFolder_ResInfo, PasteItems_ReqInfo, PasteItems_ResInfo, JoinFiles_ReqInfo, JoinFiles_ResInfo,  Search_ReqInfo, Search_ResInfo, ExtractTags_ReqInfo, ExtractTags_ResInfo, ScanTags_ReqInfo, ScanTags_ResInfo, TreeRender_ReqInfo, TreeRender_ResInfo,} from '../common/CommonTypes.js';
import { AuthenticationInfo } from '../../../common/types/CommonTypes.js';

export type TreeRenderRequest = Request<any, any, TreeRender_ReqInfo> & AuthenticationInfo;
export type TreeRenderResponse = Response<TreeRender_ResInfo>;
