...
import { DeleteRoom_ReqInfo, GetRoomInfo_ReqInfo, GetRoomInfo_ResInfo } from '../../common/CommonTypes';
...
export default function RoomsAdminComp() {
    ...
    useEffect(() => {
        const loadRoomsData = async () => {
            ...
            try {
                setLoading(true);
                const response = await httpClientUtil.secureHttpPost<GetRoomInfo_ReqInfo, GetRoomInfo_ResInfo>(`/api/admin/get-room-info`, {});
    ...
    const deleteRoom = async (roomName: string) => {
        ...
        const res = await httpClientUtil.secureHttpPost<DeleteRoom_ReqInfo, any>(`/api/admin/delete-room`, {
            roomName
        });
