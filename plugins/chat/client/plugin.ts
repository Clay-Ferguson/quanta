...
import { User, UserProfile } from '@common/types/CommonTypes';
...
class ChatClientPlugin implements IClientPlugin {
    ...
    getRoute(gs: ChatGlobalState, pageName: string) {
        ...
        case ChatPageNames.chatUserGuide:
            return React.createElement(DocViewerPage, { filename: "/docs/extensions/chat/user_guide.md", title: "Quanta Chat User Guide" });
        default: return null;
        }
    }
