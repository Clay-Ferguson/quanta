...
import { GetRecentAttachments_ResInfo } from '../../common/CommonTypes';
...
export default function RecentAttachmentsPage({ pluginTitle }: RecentAttachmentsPageProps) {
    ...
    const getAttachmentsInfo = async () => {
        setLoading(true);
        try {
            const response: GetRecentAttachments_ResInfo | null = 
                await httpClientUtil.secureHttpPost<any, GetRecentAttachments_ResInfo>(`/api/admin/get-recent-attachments`);
